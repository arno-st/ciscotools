...
## or sidbe by side if $sbs is true (by Remo 2011-2018, very ugly html cauz it's pre-formatted)
...
#echo "$act $x0:$t1[$x0] $x1:$t1[$x1] $y0:$t2[$y0] $y1:$t2[$y1]<br>\n";
                if ($act==4 and $t1[$x1] ) {
                        $row++;
                        if ($row % 2){$bg = "txta"; $bi = "imga";}else{$bg = "txtb"; $bi = "imgb";}
                        #$comon .= "$t1[$x1]\n";
                        $comon .= "<tr class=\"$bg\" onmouseover=\"this.className='$bi'\" onmouseout=\"this.className='$bg'\">\n<td 
class=\"top\">$t1[$x1]</td><td class=\"top\">$t1[$x1]</td></tr>\n";
                ...
                if ($row % 2){$bg = "txta"; $bi = "imga";}else{$bg = "txtb"; $bi = "imgb";}
                if ($op>0) {
                        $out[] = "<tr class=\"$bg\" onmouseover=\"this.className='$bi'\" onmouseout=\"this.className='$bg'\">\n";
                        if($op==1){
                        ...
                        #$out[] = "<td class=\"top\">$comon</td><td>$comon</td>\n";
                        $out[] = $comon;
                        $comon = '';
                }
                $x1++; $x0=$x1;
